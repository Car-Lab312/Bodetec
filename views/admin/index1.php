	<!-- <section class="form-register">
		...
		<h1 class="text-center">Bienvenido al Sistema BodetecPañol</h1>
		...
		<div class="col-md-6 col-xs-12 row">
			...
			<div class="col-6 mb-3">
				...
				<select class="form-select" name="solicitudes">
		...
		<button class="w-60 btn btn-lg btn-primary" type="submit" name="actualizar" id="actualizar">Actualizar</button>
