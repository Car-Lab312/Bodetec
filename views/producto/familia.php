...
<div class="Titulos">
   ...
   <section class="pantalla-princ form-register">
      ...
      <form action="<?=base_url?>familia/save" method="POST" class="align-content-stretch">
         <div class="col-md-4 col-xs-12">
               ...
               <div class="mb-4">
                  <button class="btn btn-primary" type="button" data-bs-target="#mi-question" name="add" id="add"><i class="bx bx-save me-2"></i>Guardar</button>
               </div>
         </div>
